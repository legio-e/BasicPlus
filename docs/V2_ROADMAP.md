...
| H9 | 3ª familia: **STM32** (ref. Nucleo-U575ZI-Q) | ✅ núcleo cerrado + *stretch* **AOT validado en placa** (CompressBench: interp 5125 ms → native 113 ms, **~45×**, paridad OK) — **2ª familia con AOT** · L496 diferido |
...
- **Doble-clic** en un fichero del micro → ver/editar (#231). ✅ **verificado en Pico**
