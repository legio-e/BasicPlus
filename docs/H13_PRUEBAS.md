...
- ⛔ **`ChartDemo`** — **NO PUNTÚA**: no pinta, pero **no es el widget**: el sample
  no llama a `Gui.run()` (**hallazgo 20**, ampliado). Decisión de Eduardo: no
  bloquea, se apunta y a V5.
