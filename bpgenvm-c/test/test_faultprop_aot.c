 ...
 *
 * Carga FaultProp.mod, registra el thunk AOT de readAt (que hace
...
extern void aot_FaultProp_register(struct bpvm* vm);

int main(int argc, char** argv) {
    setvbuf(stdout, NULL, _IONBF, 0);

    const char* mod_path = (argc > 1) ? argv[1] : "FaultProp.mod";
