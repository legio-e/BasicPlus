 ...
 * los usaba el fs_load() de región fija, que ya no llamaba nadie. Dos números que
 * no mandaban sobre nada: la Nucleo declaraba 128 KB mientras la placa montaba
 * 504. Se van con él. */
