// ============================================================
// BpvmClientSmoke.java
// Smoke test ejecutable del BpvmClient: lanza la VM como subproceso,
// ejecuta un .mod, y vuelca a stdout todo lo que sale por el canal
// (print del programa + eventos del debugger).
//
// Para correrlo:
//   mvn -pl BpIde exec:java -Dexec.mainClass=com.mycompany.bpide.BpvmClientSmoke \
...
public final class BpvmClientSmoke {
    public static void main(String[] args) throws Exception {
        if (args.length < 1) {
            System.err.println("uso: BpvmClientSmoke <fichero.mod o .bpproject>");
            System.exit(2);
        }
