...
- sello: boardName=`esp32c6` uniqueId=`58E6C5FFFEF9` serverName=`bpvm-esp32c6` serverBuild=`Sep 12 2026 18:28:34` capacidades=["META", "FILES", "TERMINAL"]
- imagen: arch=243 variant=None cpuFreqHz=160000000 resetReason=unknown uptimeMs=7972 fs=323584/1261568 B vmHeapBytes=65536
- al conectar: nada corria (KILL: NO_SESSION)
- transporte: serie COM3
...
| MathRango | **IDENTICO** | 0 | 8 | EXITED OK exit=0; host rc=0 |
| ThrowSinAtrapar | **IDENTICO** | 0 | 8 | EXITED RUNTIME_ERROR exit=1 (excepcion no atrapada: ALOAD: índice fuera de rango 99 (length=3)); host rc=1 |
| ThreadTrasMain | **IDENTICO** | 310 | 315 | EXITED OK exit=0; host rc=0 |
| MachineId | **NO-PETA** | 0 | 7 | EXITED OK exit=0 |
| GuiWinJson | **IDENTICO** | 560 | 41 | EXITED OK exit=0; host rc=0 |
| GuiShot | **NO-PETA** | 420 | 334 | EXITED OK exit=0 |

- tras MathRango: uptimeMs=9644 fsUsed=323584 vmHeapBytes=65536
- tras ThrowSinAtrapar: uptimeMs=10695 fsUsed=323584 vmHeapBytes=65536
- tras ThreadTrasMain: uptimeMs=11744 fsUsed=323584 vmHeapBytes=65536
- tras MachineId: uptimeMs=13227 fsUsed=323584 vmHeapBytes=65536
- tras GuiWinJson: uptimeMs=17102 fsUsed=323584 vmHeapBytes=65536
- tras GuiShot: uptimeMs=21235 fsUsed=323584 vmHeapBytes=65536
- artefacto GuiShot.shot de GuiShot: bajado a `C:\lenguajes\pm\bpgenvm-c\build\tanda\GuiShot\esp32c6_58E6C5FFFEF9\GuiShot.shot` (3038 B, crc 7459129a) -> PNG `C:\lenguajes\pm\bpgenvm-c\build\tanda\GuiShot\esp32c6_58E6C5FFFEF9\GuiShot.png`; antes del RUN: existia: /GuiShot.shot (borrado)
- ejecutadas (con EXITED) 6 de 6 listadas; no terminaron 0; saltadas 0; no llegaron a arrancar 0
...
- dependencia Machine: ya en /lib/Machine.mod (crc igual; resuelto por nombre, como el RUN)
- dependencia Gui: ya en /lib/Gui.mod (crc igual; resuelto por nombre, como el RUN)
- dependencia Json: ya en /lib/Json.mod (crc igual; resuelto por nombre, como el RUN)
- dependencia Collections: ya en /lib/Collections.mod (crc igual; resuelto por nombre, como el RUN)
- dependencia Str: ya en /lib/Str.mod (crc igual; resuelto por nombre, como el RUN)
...
| ThreadTrasMain | ThreadTrasMain | 5138ea38 | 1054 | ok | 0 | 327 | 3 |
| MachineId | MachineId | 22792db1 | 1089 | ok | 0 | 8 | 3 |
| GuiWinJson | GuiWinJson | c2e655fa | 3627 | ok | 0 | 31 | 17 |
| GuiShot | GuiShot | 61c07fa6 | 2545 | ok | 0 | 352 | 8 |
...
| prueba | modulo | crc .mod | tamano | compilacion | host rc | ms host | lineas salida |
|---|---|---|---|---|---|---|---|
| MathRango | MathRango | 05e0dfd0 | 2227 | ok | 0 | 7 | 29 |
| ThrowSinAtrapar | ThrowSinAtrapar | 422260e8 | 1800 | ok | 1 | 8 | 1 |
| ThreadTrasMain | ThreadTrasMain | 5138ea38 | 1054 | ok | 0 | 318 | 3 |
| MachineId | MachineId | 22792db1 | 1089 | ok | 0 | 9 | 3 |
| GuiWinJson | GuiWinJson | c2e655fa | 3627 | ok | 0 | 30 | 17 |
| GuiShot | GuiShot | 61c07fa6 | 2545 | ok | 0 | 334 | 8 |
...
- sello: boardName=`esp32c6` uniqueId=`58E6C5FFFEF9` serverName=`bpvm-esp32c6` serverBuild=`Sep 12 2026 18:28:34` capacidades=["META", "FILES", "TERMINAL"]
- imagen: arch=243 variant=None cpuFreqHz=160000000 resetReason=unknown uptimeMs=6932 fs=323584/1261568 B vmHeapBytes=65536
- al conectar: nada corria (KILL: NO_SESSION)
- transporte: serie COM3
- pantalla: si (INFO screenW x screenH = 240x240)
- inventario /lib+/app: 34 ficheros en /lib+/app, omitidos=0
...
| prueba | veredicto | ms placa | ms host | detalle |
|---|---|---|---|---|
| MathRango | **IDENTICO** | 10 | 7 | EXITED OK exit=0; host rc=0 |
| ThrowSinAtrapar | **IDENTICO** | 0 | 8 | EXITED RUNTIME_ERROR exit=1 (excepcion no atrapada: ALOAD: índice fuera de rango 99 (length=3)); host rc=1 |
| ThreadTrasMain | **IDENTICO** | 310 | 318 | EXITED OK exit=0; host rc=0 |
| MachineId | **NO-PETA** | 10 | 9 | EXITED OK exit=0 |
| GuiWinJson | **IDENTICO** | 560 | 30 | EXITED OK exit=0; host rc=0 |
| GuiShot | **NO-PETA** | 410 | 330 | EXITED OK exit=0 |

- tras MathRango: uptimeMs=8601 fsUsed=323584 vmHeapBytes=65536
- tras ThrowSinAtrapar: uptimeMs=9651 fsUsed=323584 vmHeapBytes=65536
- tras ThreadTrasMain: uptimeMs=10687 fsUsed=323584 vmHeapBytes=65536
- tras MachineId: uptimeMs=11952 fsUsed=323584 vmHeapBytes=65536
- tras GuiWinJson: uptimeMs=15978 fsUsed=323584 vmHeapBytes=65536
- tras GuiShot: uptimeMs=19710 fsUsed=323584 vmHeapBytes=65536
- artefacto GuiShot.shot de GuiShot: bajado a `C:\lenguajes\pm\bpgenvm-c\build\tanda\GuiShot\esp32c6_58E6C5FFFEF9\GuiShot.shot` (3038 B, crc 7459129a) -> PNG `C:\lenguajes\pm\bpgenvm-c\build\tanda\GuiShot\esp32c6_58E6C5FFFEF9\GuiShot.png`; antes del RUN: existia: /GuiShot.shot (borrado)
- ejecutadas (con EXITED) 6 de 6 listadas; no terminaron 0; saltadas 0; no llegaron a arrancar 0
...
## Tanda 2026-09-12 19:47:34

- manifiesto: `bpgenvm-c\tools\tanda_prueba.json` (6 pruebas listadas)
- oraculo: jar `lexer-java\target\basicplus-frontend.jar` (2026-09-12 19:07:28) - exe `bpgenvm-c\build\bpgenvm-c.exe` (2026-09-12 12:04:44) - sabor `gui1-lvgl1`
- placas conectadas: 1 (esp32p4@COM15)
...
- sello: boardName=`esp32p4` uniqueId=`E8F60AE0B380` serverName=`bpvm-esp32p4` serverBuild=`Sep 12 2026 18:20:05` capacidades=["META", "FILES", "TERMINAL"]
- imagen: arch=243 variant=None cpuFreqHz=360000000 resetReason=power-on uptimeMs=11508 fs=458752/7520256 B vmHeapBytes=24637440
- al conectar: nada corria (KILL: NO_SESSION)
- transporte: serie COM15
- pantalla: si (INFO screenW x screenH = 480x800)
- inventario /lib+/app: 46 ficheros en /lib+/app, omitidos=0

| prueba | veredicto | ms placa | ms host | detalle |
|---|---|---|---|---|
| MathRango | **IDENTICO** | 0 | 9 | EXITED OK exit=0; host rc=0 |
| ThrowSinAtrapar | **IDENTICO** | 10 | 9 | EXITED RUNTIME_ERROR exit=1 (excepcion no atrapada: ALOAD: índice fuera de rango 99 (length=3)); host rc=1 |
| ThreadTrasMain | **IDENTICO** | 320 | 313 | EXITED OK exit=0; host rc=0 |
| MachineId | **NO-PETA** | 0 | 8 | EXITED OK exit=0 |
| GuiWinJson | **IDENTICO** | 530 | 31 | EXITED OK exit=0; host rc=0 |
| GuiShot | **NO-PETA** | 470 | 342 | EXITED OK exit=0 |

- tras MathRango: uptimeMs=14895 fsUsed=458752 vmHeapBytes=24637440
- tras ThrowSinAtrapar: uptimeMs=16495 fsUsed=458752 vmHeapBytes=24637440
- tras ThreadTrasMain: uptimeMs=17779 fsUsed=458752 vmHeapBytes=24637440
- tras MachineId: uptimeMs=19651 fsUsed=458752 vmHeapBytes=24637440
- tras GuiWinJson: uptimeMs=24005 fsUsed=458752 vmHeapBytes=24637440
- tras GuiShot: uptimeMs=28726 fsUsed=458752 vmHeapBytes=24637440
- artefacto GuiShot.shot de GuiShot: bajado a `C:\lenguajes\pm\bpgenvm-c\build\tanda\GuiShot\esp32p4_E8F60AE0B380\GuiShot.shot` (6989 B, crc 8192c86e) -> PNG `C:\lenguajes\pm\bpgenvm-c\build\tanda\GuiShot\esp32p4_E8F60AE0B380\GuiShot.png`; antes del RUN: existia: /GuiShot.shot (borrado)
- ejecutadas (con EXITED) 6 de 6 listadas; no terminaron 0; saltadas 0; no llegaron a arrancar 0
...
| MachineId | MachineId | 22792db1 | 1089 | ok | 0 | 12 | 3 |
| GuiWinJson | GuiWinJson | c2e655fa | 3627 | ok | 0 | 39 | 17 |
| GuiShot | GuiShot | 61c07fa6 | 2545 | ok | 0 | 334 | 8 |

### Placa stm32u5 - 20353850553250040015002D

- sello: boardName=`stm32u5` uniqueId=`20353850553250040015002D` serverName=`bpvm-stm32` serverBuild=`Sep 12 2026 19:46:17` capacidades=["META", "FILES", "TERMINAL", "PACKS"]
- imagen: arch=40 variant=None cpuFreqHz=160000000 resetReason=pin (NRST) uptimeMs=7208 fs=647168/2064384 B vmHeapBytes=1179648
- al conectar: nada corria (KILL: NO_SESSION)
- transporte: serie COM12
- pantalla: si (INFO screenW x screenH = 800x480)
- inventario /lib+/app: 49 ficheros en /lib+/app, omitidos=0
...
| prueba | veredicto | ms placa | ms host | detalle |
|---|---|---|---|---|
| MathRango | **IDENTICO** | 231 | 9 | EXITED OK exit=0; host rc=0 |
| ThrowSinAtrapar | **IDENTICO** | 85 | 8 | EXITED RUNTIME_ERROR exit=1 (excepcion no atrapada: ALOAD: índice fuera de rango 99 (length=3)); host rc=1 |
| ThreadTrasMain | **IDENTICO** | 345 | 331 | EXITED OK exit=0; host rc=0 |
| MachineId | **NO-PETA** | 99 | 12 | EXITED OK exit=0 |
| GuiWinJson | **IDENTICO** | 1130 | 33 | EXITED OK exit=0; host rc=0 |
| GuiShot | **NO-PETA** | 1341 | 354 | EXITED OK exit=0 |

- tras MathRango: uptimeMs=9231 fsUsed=647168 vmHeapBytes=1179648
- tras ThrowSinAtrapar: uptimeMs=10596 fsUsed=647168 vmHeapBytes=1179648
- tras ThreadTrasMain: uptimeMs=11730 fsUsed=647168 vmHeapBytes=1179648
- tras MachineId: uptimeMs=13261 fsUsed=647168 vmHeapBytes=1179648
- tras GuiWinJson: uptimeMs=16797 fsUsed=647168 vmHeapBytes=1179648
- tras GuiShot: uptimeMs=20965 fsUsed=647168 vmHeapBytes=1179648
- artefacto GuiShot.shot de GuiShot: bajado a `C:\lenguajes\pm\bpgenvm-c\build\tanda\GuiShot\stm32u5_203538505532\GuiShot.shot` (7292 B, crc bd19c7be) -> PNG `C:\lenguajes\pm\bpgenvm-c\build\tanda\GuiShot\stm32u5_203538505532\GuiShot.png`; antes del RUN: existia: /GuiShot.shot (borrado)
- ejecutadas (con EXITED) 6 de 6 listadas; no terminaron 0; saltadas 0; no llegaron a arrancar 0
...
- sello: boardName=`esp32c6` uniqueId=`58E6C5FFFEF9` serverName=`bpvm-esp32c6` serverBuild=`Sep 12 2026 18:28:34` capacidades=["META", "FILES", "TERMINAL"]
- imagen: arch=243 variant=None cpuFreqHz=160000000 resetReason=unknown uptimeMs=9835 fs=323584/1261568 B vmHeapBytes=65536
- al conectar: nada corria (KILL: NO_SESSION)
- transporte: serie COM3
- pantalla: si (INFO screenW x screenH = 240x240)
- inventario /lib+/app: 34 ficheros en /lib+/app, omitidos=0
...
| ThreadTrasMain | **IDENTICO** | 310 | 315 | EXITED OK exit=0; host rc=0 |
| MachineId | **NO-PETA** | 0 | 7 | EXITED OK exit=0 |
| GuiWinJson | **IDENTICO** | 550 | 38 | EXITED OK exit=0; host rc=0 |
| GuiShot | **NO-PETA** | 440 | 349 | EXITED OK exit=0 |

- tras MathRango: uptimeMs=11711 fsUsed=323584 vmHeapBytes=65536
- tras ThrowSinAtrapar: uptimeMs=12946 fsUsed=323584 vmHeapBytes=65536
- tras ThreadTrasMain: uptimeMs=13998 fsUsed=323584 vmHeapBytes=65536
- tras MachineId: uptimeMs=15234 fsUsed=323584 vmHeapBytes=65536
- tras GuiWinJson: uptimeMs=18522 fsUsed=323584 vmHeapBytes=65536
- tras GuiShot: uptimeMs=22606 fsUsed=323584 vmHeapBytes=65536
- artefacto GuiShot.shot de GuiShot: bajado a `C:\lenguajes\pm\bpgenvm-c\build\tanda\GuiShot\esp32c6_58E6C5FFFEF9\GuiShot.shot` (3038 B, crc 7459129a) -> PNG `C:\lenguajes\pm\bpgenvm-c\build\tanda\GuiShot\esp32c6_58E6C5FFFEF9\GuiShot.png`; antes del RUN: existia: /GuiShot.shot (borrado)
- ejecutadas (con EXITED) 6 de 6 listadas; no terminaron 0; saltadas 0; no llegaron a arrancar 0
