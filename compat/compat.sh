...
CORPUS="hello arith strings concat charat counter MethodCall trycatch \
        ...
        samples/LocalArrTest.bp samples/StrOps348.bp samples/MathOps348.bp samples/PathOps348.bp samples/EvFin.bp samples/ThreadTrasMain.bp         SciPar ArrLitAncho"
